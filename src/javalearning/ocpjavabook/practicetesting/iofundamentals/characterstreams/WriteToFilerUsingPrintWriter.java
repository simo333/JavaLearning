...
public class WriteToFilerUsingPrintWriter {
    public static void main(String[] args) {
        try {
            FileWriter fw = new FileWriter("C:\\Users\\SimoPc\\IdeaProjects\\AccessModifiers\\IOTests1\\CreateDirectory\\MyTextPrintWriter.txt");
